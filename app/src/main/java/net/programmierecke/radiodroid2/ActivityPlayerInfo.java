...
public class ActivityPlayerInfo extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Started some work on Wifi-awareness, but not finished at all, see also
		// https://stackoverflow.com/questions/9353005/android-wifi-how-to-detect-when-specific-wifi-connection-is-available
